    ...
    <div className="min-h-screen bg-slate-50">
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              ...
              <nav className="hidden md:ml-8 md:flex space-x-1">
                ...
                <button onClick={() => navigate('/settings')} className="text-slate-700 bg-red-50 px-4 py-2 rounded-lg text-sm font-medium">Settings</button>
              </nav>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full">
        <div className="mb-8">
          ...
          <p className="text-slate-600">Configure your VoiceCRM preferences and integrations</p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg border border-slate-200 p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  <label className="text-sm font-medium text-slate-900">Auto-process recordings</label>
                  <p className="text-sm text-slate-600">Automatically process voice recordings when received</p>
                </div>
                <button
                  onClick={() => handleSettingChange('autoProcess', !settings.autoProcess)}
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-slate-600">Receive email alerts for important activities</p>
                </div>
                <button
              ...
              <div className="flex items-center justify-between">
                <div>
                  <label className="text-sm font-medium text-slate-900">Voice detection</label>
                  <p className="text-sm text-slate-600">Automatically detect and segment voice conversations</p>
                </div>
                <button
                  onClick={() => handleSettingChange('voiceDetection', !settings.voiceDetection)}
                  className={`relative inline-flex h-6 w-11 items-center rounded-full ${
                    settings.voiceDetection ? 'bg-red-600' : 'bg-slate-300'
                  }`}
                >
                  <span className={`inline-block h-4 w-4 transform rounded-full bg-white transition ${
                    settings.voiceDetection ? 'translate-x-6' : 'translate-x-1'
                  }`} />
                </button>
              </div>
            </div>
          ...
          {/* Connected Services */}
          <div className="bg-white rounded-lg border border-slate-200 p-6">
            <h2 className="text-lg font-bold text-slate-900 mb-4">Connected Services</h2>
                ...
                <div key={service} className="flex items-center justify-between p-3 border border-slate-200 rounded-lg">
                  <div className="flex items-center gap-3">
                    <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${
                      connected ? 'bg-green-100 text-green-600' : 'bg-slate-100 text-slate-600'
                    }`}>
                    ...
                    <div>
                      <h3 className="font-medium text-slate-900 capitalize">{service}</h3>
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg text-sm font-medium ${
                      connected ? 'bg-red-600 text-white hover:bg-red-700' : 'bg-green-600 text-white hover:bg-green-700'
                    }`}
                  >
          ...
          {/* Data Management */}
          <div className="bg-white rounded-lg border border-slate-200 p-6">
            <h2 className="text-lg font-bold text-slate-900 mb-4">Data Management</h2>
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  <label className="text-sm font-medium text-slate-900">Automatic backups</label>
                  <p className="text-sm text-slate-600">Backup your data automatically every week</p>
                </div>
                <button
          ...
          <div className="bg-white rounded-lg border border-slate-200 p-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  <span className="px-3 py-1 bg-red-100 text-red-700 rounded-full text-sm font-medium">Pro Plan</span>
